    ...
    <Page title="Mon CV">
      ...
      <div className=" flex flex-col self-center justify-center w-[100%] text-lg sm:text-xl lg:text-xxl font-extrabold  ">
        ...
        <div className="flex flex-col md:flex-row justify-around items-center  w-[100%]">
          <section className="flex flex-col items-center rounded-full bg-gray-200 border-4 border-cyan-500 p-5 w-[90%] md:w-[50%]">
            <h1>Skills</h1>
          ...
          <section className="flex flex-col mt-20 sm:mt-0 justify-center items-center rounded-full border-4 border-cyan-500 bg-gray-200  items-center pt-5 h-full w-[80%] sm:w-[45%]">
            <h1>Parcours</h1>
